...
___
The Step is to get the x86 version of the drivers from PC. For ARM, please contact the supplier of the peripheral to get the sys/inf files. For any missing Drivers, please contact the supplier of the peripheral to get the sys/inf files (especially for ARM32 and ARM64)
